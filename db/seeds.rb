...
excuse3 = CreativeExcuse.create!(user: user1, title: 'The Haddock Flies at midnight', description: "A cryptic clue to keep you guessing", remote_photo_url: coffee)
excuse4 = CreativeExcuse.create!(user: user2, title: 'Had to lose a heat seeking missile first', description: "It followed me from Bombay to Berlin", remote_photo_url: missile)
excuse5 =CreativeExcuse.create!(user: user3, title: "Haven't mastered time travel yet", description: "The death of my close friend, Mr Hawking, has put me back a few hours", remote_photo_url: time_travel)
excuse6 = CreativeExcuse.create!(user: user4, title: 'I am rubber, you are glue', description: "And therefore my lateness has nothing to do with you", remote_photo_url: nope)
excuse7 = CreativeExcuse.create!(user: user1, title: 'I was up all night arguing with my god', description: "It was a battle he didn't let me with nor did he let me lose", remote_photo_url: god)
excuse8 = CreativeExcuse.create!(user: user4, title: 'Croquet Championships', description: "My participation was mandatory as the English #3", remote_photo_url: croquet)
excuse9 = CreativeExcuse.create!(user: user3, title: 'Disposing of body', description: "I didn't know where to put it at first", remote_photo_url: body)
excuse10 = CreativeExcuse.create!(user: user3, title: 'Helping to dispose of body', description: "I had space in the freezer in my shed", remote_photo_url: body)
excuse11 = CreativeExcuse.create!(user: user3, title: 'It burns', description: "He took longer than I thought it would to burn completely", remote_photo_url: burn)
