...
excuse12 = CreativeExcuse.create!(user: user1, title: 'Hot Air Balloon Issues', description: "I was hot air ballooning it and the wind changed direction", category: "funny" )
